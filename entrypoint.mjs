export function entrypoint({
  checkpoint, defaultPrompt, promptNode, latent, ksampler, saveImage,
}) {
...
prompt = os.environ.get("PROMPT") or "${defaultPrompt}"
# 
...
chkpoint_loader_node = prompt_workflow["${checkpoint}"]
prompt_pos_node = prompt_workflow["${promptNode}"]
empty_latent_img_node = prompt_workflow["${latent}"]
ksampler_node = prompt_workflow["${ksampler}"]
save_image_node = prompt_workflow["${saveImage}"]
